...
export default function Psych3Page() {
  const { psych_scores, setPsychScore, nextStep } = useOnboardingStore()
  const router = useRouter()

  function handleSelect(value: string) {
    setPsychScore(2, parseInt(value, 10))
    nextStep()
    router.push('/onboarding/psych-4')
  }

  const currentValue = psych_scores[2]?.toString()
  ...
  return (
    <OnboardingLayout
      ...
      onBack={() => router.push('/onboarding/psych-2')}
    >
